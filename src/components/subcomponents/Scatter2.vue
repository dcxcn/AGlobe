...
export default {
  ...
  methods: {
    ...
    submit () {
      ...
      this.echartsCombineCesium(viewer, option)
    ...
    /**
             * cesium结合echarts
             * */
    echartsCombineCesium: function (viewer, option) {
      // 坐标转换及事件监听
      // 这个写法就是执行这个匿名函数，参数是最后一个括号中的内容
      (function (e) {
        var t = {}
        ...
        var i = (function () {
          ...
          },
          {
            ...
            value: function (e) {
              ...
              var n = [0, 0]
              var r = Cesium.Cartesian3.fromDegrees(e[0], e[1])
              if (!r) return n
          ...
          },
          {
            ...
            value: function (e) {
              ...
              var n = viewer.scene.globe.ellipsoid
              var r = new Cesium.cartesian3(e[1] + t, e[2] + t[2], 0)
              var i = n.cartesianToCartographic(r)
              return [i.lng, i.lat]
            }
          },
          {
